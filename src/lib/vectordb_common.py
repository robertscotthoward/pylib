...
def make_vectordb(collection_name, corpus_folder, collection_folder=None, reranker=None, load_corpus=True):
    ...
    vdb = ChromaVectorDb(corpus, splitter, collection_path=collection_folder, reranker=reranker)
